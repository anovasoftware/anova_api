# Generated by Django 5.1.12 on 2026-03-30 12:53
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('static', '0039_alter_table_can_delete_alter_table_can_update'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            name='Grid',
            fields=[
                ('grid_id', models.CharField(max_length=3, primary_key=True, serialize=False, unique=True)),
                ...
                ('grid_key', models.CharField(default='', max_length=50)),
