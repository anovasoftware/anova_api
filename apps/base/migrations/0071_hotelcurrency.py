# Generated by Django 5.1.12 on 2026-07-29 10:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='HotelCurrency',
            fields=[
                ('hotel_currency_id', models.CharField(max_length=4, primary_key=True, serialize=False)),
            ...
            options={
                ...
                'ordering': [],
                'constraints': [models.UniqueConstraint(fields=('hotel', 'currency'), name='unique_hotel_currency')],
            },
        ),
    ]
